...
import {ACCEPT_ARTICLE} from './ButtonsNaming.js';
import {isGanache} from '../../../../../helpers/isGanache.mjs';
import toast from '../../../design-components/Notification/Toast.js';

export const acceptArticle = async (web3Context, props, callback) => {
    let gasAmount;
...
export const AcceptArticleButton = connect(
  mapStateToProps,
  mapDispatchToProps
)(props => {
  return (
      ...
      {web3Context => {
        return (
          <ActionButton
            ...
            dataTip={'acceptArticle'}
            onClick={() => {
              acceptArticle(web3Context, props, () => {
                props.fetchingArticleData(props.article._id);
              });
            }}
            title={ACCEPT_ARTICLE.tooltip}  
          >
            {ACCEPT_ARTICLE.label}
          </ActionButton>
        );
      }}
    </Web3Context.Consumer>
