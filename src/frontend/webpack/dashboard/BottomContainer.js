  ...
  return (
    <Container>
      <BallsContainer>
        ...
        <Ball rgb={rgb} left={50} top={257} intensity={0.03} width={200} />
        <Ball rgb={rgb} left={606} top={757} intensity={0.015} width={150} />
        <Ball rgb={rgb} left={457} top={200} intensity={0.05} width={400} />
        <Ball rgb={rgb} left={10} top={600} intensity={0.1} width={200} />
        <Ball rgb={rgb} left={50} top={700} intensity={0.05} width={150} />
        ...
        <Ball rgb={rgb} right={500} top={740} intensity={0.05} width={545} />
      </BallsContainer>
      {props.children}
    </Container>
  );
